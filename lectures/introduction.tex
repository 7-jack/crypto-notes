...
\begin{example}
    ...
    \begin{itemize}
        ...
        \item \vocab{Try 4: Secure if the adversary cannot derive any \textit{meaningful} information from the ciphertext}
        ...
        \item \vocab{Try 5: Secure if the adversary cannot compute \textit{any} function of the plaintext from the ciphertext}
...
\begin{remark}
    For most of these notes, we will consider adversaries that are \vocab{efficient}: that is, those that run in polynomial time.
\end{remark}
